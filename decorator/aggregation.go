...
//Aged defines interface for age getters and setters
type Aged interface {
  Age() int
  SetAge(age int)
}

//notice age is private
type Bird struct {
  age int
}
...
//notice we keeping them private
type Dragon struct {
  bird Bird
  lizard Lizard
}

//we redefine the behaviors
...
//Need a factor function so we can initialize private fields.
