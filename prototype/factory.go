...
//   ↓ lowercase
//this takes one of our prototypes above and creates a new object based on those, only changing some methods
...
//these are the func that we would expose,
//it calls above function
